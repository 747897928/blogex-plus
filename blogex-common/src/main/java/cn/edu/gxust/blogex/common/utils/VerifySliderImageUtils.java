 ...
 */
public class VerifySliderImageUtils {
    ...
    private static final Logger logger = LoggerFactory.getLogger(VerifySliderImageUtils.class);
     ...
     * @return 切图结果信息
     */
    public static Verification pictureTemplatesCut(File templateFile, File targetFile) throws Exception {
        ...
        verification.setOriginalImage(base64.encodeToString(oriImageByte));
        verification.setSlidingImage(base64.encodeToString(newImagebyte));
        verification.setxWidth(widthRandom);
        verification.setyHeight(heightRandom);
