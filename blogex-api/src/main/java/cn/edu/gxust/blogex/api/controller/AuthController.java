...
public class AuthController {
    ...
    public Result<BlogUser> login(@RequestBody AuthDTO authDTO) {
        return Result.success(authService.login(authDTO));
    }

    @ApiOperation(value = "登出")
    @GetMapping(value = "/logout")
    public Result<String> logout(@RequestHeader(value = Constants.AUTHORIZATION) String token) {
